...
func TestSafeLoginReturnPathRejectsOpenRedirectAndUnsafeRoutes(t *testing.T) {
	cases := []struct {
		...
		{raw: "/knowledge", want: "/knowledge", ok: true},
		{raw: "/knowledge/flows/approved-use", want: "/knowledge/flows/approved-use", ok: true},
...
func TestRouteValueLeakSentinelCoversPublicAPIAndUI(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "managed dynamic host package unavailable", pattern: "GET /internal/managed-environment-host-packages/{hostRef}", method: http.MethodGet, path: "/internal/managed-environment-host-packages/host_0123456789abcdef", status: http.StatusNotFound},
		{name: "managed dynamic host receipt unavailable", pattern: "POST /internal/managed-environment-host-packages/{hostRef}/{operationRef}/receipt", method: http.MethodPost, path: "/internal/managed-environment-host-packages/host_0123456789abcdef/op_0123456789abcdef/receipt", status: http.StatusNotFound},
		...
		{name: "knowledge", pattern: "GET /knowledge", method: http.MethodGet, path: "/knowledge", status: http.StatusOK},
		{name: "knowledge flow", pattern: "GET /knowledge/flows/{flowSlug}", method: http.MethodGet, path: "/knowledge/flows/approved-use", status: http.StatusOK},
